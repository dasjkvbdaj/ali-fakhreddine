...
const ProjectPanel = ({
  ...
  <motion.div
    ...
    className={cn(
      ...
      open
        ? "border-primary/40 ring-1 ring-primary/20 shadow-elevated"
        : "border-border hover:-translate-y-1 hover:border-primary/30 hover:shadow-glow",
    )}
  >
    {/* Image Container */}
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            {project.demo && project.demo !== "#" && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-primary py-2 text-xs font-semibold text-primary-foreground shadow-glow transition-all hover:opacity-90"
              >
